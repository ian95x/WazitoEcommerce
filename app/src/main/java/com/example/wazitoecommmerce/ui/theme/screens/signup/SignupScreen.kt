package com.example.wazitoecommmerce.ui.theme.screens.signup
...
fun SignupScreen() {
    Box (Modifier.fillMaxSize(),
        ...
        val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(R.raw.batman))
        LottieAnimation(
